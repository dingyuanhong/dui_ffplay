...
public:
	...
	CControlUI* GetHover()const {return m_pEventHover;}
	void SetHover(CControlUI* pControl) { m_pEventHover = pControl;}
	CControlUI *GetEventClick()const{return m_pEventClick;};
